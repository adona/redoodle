...
/******/ 	return __webpack_require__(__webpack_require__.s = "./base/static/base/src/jsx/form.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./base/static/base/src/jsx/form.js":
/*!******************************************!*\
  !*** ./base/static/base/src/jsx/form.js ***!
  \******************************************/
/*! exports provided: Form, Input, Submit, validators */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _csrf_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./csrf.js */ "./base/static/base/src/jsx/csrf.js");
/* harmony import */ var _scss_form_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../scss/form.scss */ "./base/static/base/src/scss/form.scss");
/* harmony import */ var _scss_form_scss__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_scss_form_scss__WEBPACK_IMPORTED_MODULE_3__);
...
function (_React$Component) {
  ...
  function Form(props) {
    ...
    _this.onServerSideErrors = _this.onServerSideErrors.bind(_assertThisInitialized(_this));
    return _this;
  }
  ...
  _createClass(Form, [{
    ...
    value: function getValidators(field) {
      ...
      if (field.props.required) {
        var validateRequired = validators.getValidateRequired(field.props.requiredMessage);
    ...
    value: function onSubmit(e) {
      ...
      for (var _i3 = 0, _Object$keys2 = Object.keys(this.state.fields); _i3 < _Object$keys2.length; _i3++) {
        var fieldName = _Object$keys2[_i3];
      ...
      if (this.props.onSubmit != undefined) {
        ...
        // Post to submitURL
        jquery__WEBPACK_IMPORTED_MODULE_0___default.a.post(this.props.submitURL, formValues).done(function (response) {
    ...
    value: function onServerSideErrors(response) {
      ...
      if (clientErrorCodes.includes(response.status)) {
        ...
        for (var _i4 = 0, _Object$keys3 = Object.keys(errors); _i4 < _Object$keys3.length; _i4++) {
          var fieldName = _Object$keys3[_i4];
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("form", {
        ...
        return !_this3.isField(child) ? child : react__WEBPACK_IMPORTED_MODULE_1___default.a.cloneElement(child, {
          key: idx,
          ...
          onValueChange: _this3.onValueChange,
          onBlur: _this3.onBlur
        });
      }), this.state.nonFieldErrors == null ? "" : react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
...
function (_React$Component2) {
  ...
  function Input(props) {
    ...
    _this4 = _possibleConstructorReturn(this, _getPrototypeOf(Input).call(this, props));
    _this4.onValueChange = _this4.onValueChange.bind(_assertThisInitialized(_this4));
...
function (_React$Component3) {
  _inherits(Submit, _React$Component3);
...
var validators = {
  getValidateRequired: function getValidateRequired(errorMessage) {
  ...
  validatePasswordMatch: function validatePasswordMatch(value, fieldName, formState) {
...
/***/ "./base/static/base/src/scss/form.scss":
/*!*********************************************!*\
  !*** ./base/static/base/src/scss/form.scss ***!
  \*********************************************/
